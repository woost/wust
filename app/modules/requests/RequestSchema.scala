...
case class StartConnectSchema[START <: Node, RELATION <: ContentRelation[START,END], END <: ContentNode](factory: ContentRelationFactory[START,RELATION,END]) extends SimpleConnectSchema[START]
case class EndConnectSchema[START <: ContentNode, RELATION <: ContentRelation[START,END], END <: Node](factory: ContentRelationFactory[START,RELATION,END]) extends SimpleConnectSchema[END]
...
case class StartHyperConnectSchema[START <: ContentNode, RELATION <: ContentRelation[START,END] with Node, END <: ContentNode](override val factory: ContentRelationFactory[START,RELATION,END] with NodeFactory[RELATION], override val connectSchemas: Map[String,SimpleConnectSchema[RELATION]]) extends HyperConnectSchema[START] with NodeSchemaBase[RELATION]
...
object StartConnection {
  def unapply[START <: Node](schema: ConnectSchema[START]) = schema match {
