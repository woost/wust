...
//TODO code dub in schema/moderation: how to share this trait between schema and scalajs-shared project
trait ModerationBase {
  ...
  def postChangeThreshold(viewCount: Long):Long = sqrt(viewCount) + 1 // One needs min 256 karma to do instant edits on new posts
