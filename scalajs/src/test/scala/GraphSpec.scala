...
object TestHelpers {
  ...
  implicit def n(id: String) = new RawNode(id = id, title = "", description = None, isHyperRelation = false, startId = None, endId = None, tags = js.Array(), timestamp = 0, quality = 0, viewCount = 0)
  implicit def r(t: (String, String)) = new RawRelation(t._1, t._2)
implicit def h(startId: String, id: String, endId: String) = new RawNode(id = id, title = "", description = None, isHyperRelation = true, startId = Some(startId), endId = Some(endId), tags = js.Array(), timestamp = 0, quality = 0, viewCount = 0)
